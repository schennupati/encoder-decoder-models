...
inst_labels = [
    ...
    Label('truck', 4,       4, 'vehicle', 7, True, False, (250, 170, 160)),
    Label('bus', 5,       5, 'vehicle', 7, True, False, (102, 102, 156)),
    Label('caravan', 6,       6, 'vehicle', 7, True, True, (153, 153, 153)),
    Label('trailer', 7,       7, 'vehicle', 7, True, True, (70, 130, 180)),
...
cat_labels = [
    ...
    Label('building',  2,        2, 'construction',
          2, False, False, (70, 70, 70)),
    Label('wall',  3,        3, 'construction',
          2, False, False, (102, 102, 156)),
    Label('fence',  4,        4, 'construction',
          2, False, False, (190, 153, 153)),
    Label('pole',  5,        5, 'object', 3, False, False, (153, 153, 153)),
    Label('traffic light',  6,        6, 'object',
          3, False, False, (250, 170, 30)),
    Label('traffic sign',  7,        7, 'object',
          3, False, False, (220, 220,  0)),
    Label('vegetation',  8,        8, 'nature',
          4, False, False, (107, 142, 35)),
